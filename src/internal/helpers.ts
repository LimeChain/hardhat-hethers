...
//   const { Signer } = require("hethers") as typeof hethers;
...
//   libraries: Libraries
// ) {
//   const { utils } = require("hethers") as typeof hethers;
//
...
//   signer?: hethers.Signer
// ) {
//   const { ContractFactory } = require("hethers") as typeof hethers;
//
//   if (signer === undefined) {
...
//   }
//
//   const { Contract } = require("hethers") as typeof hethers;
//
//   if (signer === undefined) {
//     const signers = await hre.hethers.getSigners();
//     signer = signers[0];
...
// // This is done so that hethers doesn't automatically estimate gas limits on
// // every call.
// function addGasToAbiMethodsIfNecessary(
//   networkConfig: NetworkConfig,
//   abi: any[]
// ): any[] {
//   const { BigNumber } = require("hethers") as typeof hethers;
//
//   if (networkConfig.gas === "auto" || networkConfig.gas === undefined) {
//     return abi;
//   }
//
//   // hethers adds 21000 to whatever the abi `gas` field has. This may lead to
...
//   // HOTFIX: We substract 1M for now. See: https://github.com/hethers-io/hethers.js/issues/1058#issuecomment-703175279
